...
namespace PergunteAqui.Service.Generic
{
    public interface IBaseService<TEntity> where TEntity : class
    {
        ...
        /// <exception cref="PergunteAqui.Domain.Exceptions.ShareBookException">In case that more than 1 entity could be returned for the filter specified.</exception>
