...
using PergunteAqui.Api.Configuration;
using PergunteAqui.Api.Middleware;
using PergunteAqui.Repository;

namespace PergunteAqui.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "PERGUNTE AQUI API V1");
            });
            ...
            using (var serviceScope = app.ApplicationServices.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                ...
                {
                    var sharebookSeeder = new DatabaseInitialSeeder(context);
